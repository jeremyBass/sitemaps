...
class Wsu_Adminhtml_Model_System_Config_Backend_Sitemap_Cron extends Mage_Core_Model_Config_Data
{

    const CRON_STRING_PATH = 'crontab/jobs/sitemaper_generate/schedule/cron_expr';
    const CRON_MODEL_PATH = 'crontab/jobs/sitemaper_generate/run/model';
