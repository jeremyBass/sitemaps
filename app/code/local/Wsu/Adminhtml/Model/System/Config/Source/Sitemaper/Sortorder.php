...
class Wsu_Adminhtml_Model_System_Config_Source_Sitemaper_Sortorder
{

    public function toOptionArray()
    {
        return array(
            array('value'=>'position', 'label'=>Mage::helper('sitemaper')->__('Position')),
            array('value'=>'name', 'label'=>Mage::helper('sitemaper')->__('Name')),
        );
    }
