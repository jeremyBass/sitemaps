...
class Wsu_Adminhtml_Block_Sitemaper_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_addButton('generate', array(
            'label'   => Mage::helper('sitemaper')->__('Save & Generate'),
    ...
    public function getHeaderText()
    {
        if (Mage::registry('sitemap_sitemap')->getId()) {
            return Mage::helper('sitemaper')->__('Edit Sitemap');
        }
        else {
            return Mage::helper('sitemaper')->__('New Sitemap');
        }
    }
}
