...
class Wsu_Adminhtml_Block_Sitemaper_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        /* @var $collection Wsu_Sitemaper_Model_Mysql4_Sitemap_Collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('link', array(
            ...
            'renderer'  => 'wsu/sitemaper_grid_renderer_link',
        ));
        ...
        $this->addColumn('action', array(
            ...
            'sortable' => false,
            'width'    => '100',
            'renderer' => 'wsu/sitemaper_grid_renderer_action'
        ));
