 ...
 *
 * @category   Wsu
 * @package    Wsu_SearchAutocomplete
...
class Wsu_SeoSuite_Model_Catalog_Product_Attribute_Source_Meta_Robots extends Mage_Eav_Model_Entity_Attribute_Source_Abstract
{
