 ...
 * @author     Wsu Dev Team
 */
class Wsu_Sitemaper_Model_Mysql4_Catalog_Product extends Mage_Core_Model_Mysql4_Abstract {
...
//        );        
        ...
        $productCanonicalUrl = Mage::getStoreConfig('wsu_seo/seosuite/product_canonical_url');
